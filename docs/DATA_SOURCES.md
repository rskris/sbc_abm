...
| OpenStreetMap | Geofabrik / Overpass | Routable highway, bike, walk networks | County | `network/build.py` *(osm extra)* |
| GTFS — SBMTD | Santa Barbara MTD | Local transit routes, stops, schedules | County | `data/transit.py` |
| GTFS — Clean Air Express / Amtrak | respective agencies | Regional/commuter transit | Region | `data/transit.py` |
